       ...
       // GUARDAR NOVO CLIENTE
        server.createContext("/guardar", exchange -> {
            ...
            try {
                ...
                String sql = "INSERT INTO clientes(nome,pais,nif,email,telefone) VALUES (?,?,?,?,?)";
        ...
        server.createContext("/editar", exchange -> {
            ...
            try {
                ...
                html.append("Pais:<input name='pais' value='").append(pais).append("' required>");
        ...
        server.createContext("/atualizar", exchange -> {
            ...
            try {
                ...
                String sql = "UPDATE clientes SET nome=?, pais=?, email=?, telefone=? WHERE id=?";
                PreparedStatement ps = con.prepareStatement(sql);
        ...
        server.createContext("/animais", exchange -> {
            ...
            StringBuilder html = new StringBuilder();
                ...
                html.append("""
                    ...
                    <a href='/novoanimal'>+ Novo Animal</a><br><br>
